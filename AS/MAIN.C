...
FILE *in_fp = NULL;	/* file pointers, input */
FILE *lst_fp = NULL;	/* listing */
...
int   autozp_opt;	/* auto zeropage mode for NES ONLY */
...
help(void)
{
	...
	// 2010/12/30 minachun add.
		...
		printf("-autozp: assemble auto zeropage memory access. Ex) lda ($nn),y\n");
	}
	// 2010/12/30 minachun end.
